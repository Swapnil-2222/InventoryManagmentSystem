...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.techvg.ims.domain.Product.class.getName() + ".productTransactions");
            createCache(cm, com.techvg.ims.domain.Categories.class.getName());
            createCache(cm, com.techvg.ims.domain.Categories.class.getName() + ".products");
            createCache(cm, com.techvg.ims.domain.Unit.class.getName());
            createCache(cm, com.techvg.ims.domain.Unit.class.getName() + ".products");
            ...
            createCache(cm, com.techvg.ims.domain.ProductInventory.class.getName() + ".productTransactions");
            ...
            createCache(cm, com.techvg.ims.domain.ProductTransaction.class.getName() + ".products");
            createCache(cm, com.techvg.ims.domain.PurchaseOrder.class.getName());
            createCache(cm, com.techvg.ims.domain.PurchaseOrder.class.getName() + ".purchaseOrderDetails");
            createCache(cm, com.techvg.ims.domain.PurchaseOrder.class.getName() + ".goodReciveds");
            createCache(cm, com.techvg.ims.domain.PurchaseOrder.class.getName() + ".productInventories");
            createCache(cm, com.techvg.ims.domain.PurchaseOrderDetails.class.getName());
            createCache(cm, com.techvg.ims.domain.PurchaseOrderDetails.class.getName() + ".products");
            ...
            createCache(cm, com.techvg.ims.domain.SecurityUser.class.getName() + ".productTransactions");
            createCache(cm, com.techvg.ims.domain.SecurityUser.class.getName() + ".products");
            ...
            createCache(cm, com.techvg.ims.domain.SecurityUser.class.getName() + ".securityUsers");
