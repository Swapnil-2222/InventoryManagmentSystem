...
export class TransferRecievedService {
  ...
  protected convertDateFromClient(transferRecieved: ITransferRecieved): ITransferRecieved {
    return Object.assign({}, transferRecieved, {
      ...
      lastModified: transferRecieved.lastModified?.isValid() ? transferRecieved.lastModified.toJSON() : undefined,
    });
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((transferRecieved: ITransferRecieved) => {
        ...
        transferRecieved.lastModified = transferRecieved.lastModified ? dayjs(transferRecieved.lastModified) : undefined;
      });
    }
    return res;
  }
