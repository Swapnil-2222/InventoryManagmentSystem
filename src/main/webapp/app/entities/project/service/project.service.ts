...
export class ProjectService {
  ...
  protected convertDateFromClient(project: IProject): IProject {
    return Object.assign({}, project, {
      ...
      lastModified: project.lastModified?.isValid() ? project.lastModified.toJSON() : undefined,
    });
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((project: IProject) => {
        ...
        project.endDate = project.endDate ? dayjs(project.endDate) : undefined;
        project.lastModified = project.lastModified ? dayjs(project.lastModified) : undefined;
      });
    }
    return res;
  }
